...
export const Sidebar: React.FC<Props> = ({ 
  ...
  // Responsive classes: flex-row for mobile, flex-col for desktop
  ...
  return (
    <aside className="w-full md:w-64 flex-shrink-0 flex flex-col gap-6 md:block">
      ...
      {/* Mobile-Friendly Sticky Top/Bottom Nav Wrapper on Desktop it acts as normal sticky */}
        ...
        <div className="border-b md:border-b-0 md:border-l border-zinc-200 dark:border-zinc-800/50 pb-2 md:pb-0 overflow-x-auto md:overflow-visible">
           ...
           <nav className="flex md:flex-col space-x-1 md:space-x-0 md:space-y-0.5 min-w-max px-2 md:px-0">
             ...
             <button onClick={() => onChangeView('feed')} className={navItemClass('feed')}>
                ...
                <span className="relative z-10 tracking-wide">INDEX</span>
             </button>
             ...
             <button onClick={() => onChangeView('analytics')} className={navItemClass('analytics')}>
                ...
                <span className="relative z-10 tracking-wide">STATS</span>
             </button>
             ...
             <button onClick={() => onChangeView('calculator')} className={navItemClass('calculator')}>
                ...
                <span className="relative z-10 tracking-wide hidden md:inline">CALCULATOR</span>
             ...
             <button onClick={() => onChangeView('generator')} className={navItemClass('generator')}>
                ...
                <span className="relative z-10 tracking-wide hidden md:inline">REPORT_GEN</span>
             ...
             <button onClick={() => onChangeView('wizard')} className={navItemClass('wizard')}>
                ...
                <span className="relative z-10 tracking-wide hidden md:inline">DIAGNOSE</span>
                <span className="md:hidden">WIZ</span>
             </button>
             ...
             <button onClick={() => onChangeView('checklist')} className={navItemClass('checklist')}>
                ...
                <span className="relative z-10 tracking-wide hidden md:inline">CHECKLIST</span>
             ...
             <button onClick={() => onChangeView('dev-portal')} className={`${navItemClass('dev-portal')} md:mt-4 md:border-t md:border-zinc-200 md:dark:border-zinc-800/50 md:pt-4`}>
                  ...
                  <span className="relative z-10 tracking-wide hidden md:inline">DEV_API</span>
